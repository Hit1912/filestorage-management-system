...
const Docs = () => {
  ...
  return (
    <PageLayout title="Docs" subtitle="DHR Nest API Documentation">
      <div className="mx-auto px-1">
        <div className="mb-8">
          <h2 className="text-lg font-semibold">TypeScript/JavaScript SDK</h2>
          <p className="text-sm text-muted-foreground mb-6">
            TypeScript library for uploading files to DHR Nest API. Works in
          ...
          <Card className="mb-6">
            ...
            <CardContent>
              <div className="overflow-x-auto rounded-lg border">
                ...
                >
                  {`import { DHRNestClient } from "@dhrnest/client";

const client = new DHRNestClient({
  apiKey: process.env.DHRNEST_API_KEY, // Your API key
});
...
const client = new DHRNestClient({
  apiKey: process.env.DHRNEST_API_KEY,
});
          ...
          <Card className="mb-6">
            ...
            <CardContent>
              <div className="overflow-x-auto rounded-lg border">
                ...
                >
                  {`import { ValidationError, UploadError } from "@dhrnest/client/errors";
        ...
        <div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Interact with the DHR Nest API directly using standard HTTP
