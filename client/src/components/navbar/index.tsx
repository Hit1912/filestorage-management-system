...
const Navbar = () => {
  ...
  return (
    <>
      <header className="mx-auto sticky top-0 glass flex h-16 lg:h-24 w-full max-w-7xl items-center justify-between gap-x-4 px-4 lg:px-8 z-50 transition-all duration-300">
